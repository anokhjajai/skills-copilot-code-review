...
def init_database():
    ...
    if announcements_collection.count_documents({}) == 0:
        for announcement in initial_announcements:
            ...
            announcement["created_at"] = announcement.get("created_at") or timestamp
            announcement["updated_at"] = announcement.get("updated_at") or timestamp
...
initial_announcements = [
    {
        "title": "Spring Activities Showcase",
        "message": "Join us in the gym on Friday at 6 PM to meet club leaders and sign up.",
